...
public class US01_TC07 {
    /*
    Bu testte sinir deger analizi teknigi kullanilmaktadir
     */
    @Test
    public void password12Char() {
        ...
        homePage.passwordTabAyse.sendKeys(ConfigReader.getProperty("sinirDegerKarakter12Password"));
        ReusableMethods.extentTest.info("Kullanici 12 karakterli bir password girdi");
