...
public class US01_TC09 {
    /*
    Bu testte sinir deger analizi kullanilmistir
     */
    public void passWith13Char() {
        ...
        homePage.passwordTabAyse.sendKeys(ConfigReader.getProperty("sinirDegerKarakter13Password"));
        ReusableMethods.extentTest.info("Kullanici 13 karakterli password girdi");
