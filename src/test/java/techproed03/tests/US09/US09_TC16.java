   ...
   // @Test
    //public void test_US_09_TC_16() throws IOException {
      ...
      /*  Driver.getDriver().get(ConfigReader.getProperty("app_home_url"));
        ...
        AlloverPage.confirmPassword.sendKeys(ConfigReader.getProperty("strong_password"));
        ...
        Assert.assertTrue(AlloverPage.errorMessage.getText().equals("This Email already exists. Please login to the site and apply as vendor."));
