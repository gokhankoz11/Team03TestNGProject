...
public class US12_Test07 {
    ...
    public void test07() {
        ...
        //Billing address bilgilri doldurulur
        ...
        //Postcode bölümü bos birakilir
        alloverPage.billingpostcodeBox_ofa.sendKeys(Keys.TAB + ConfigReader.getProperty("phone_ofa") + Keys.TAB + Keys.TAB + Keys.ENTER);
        String eyba = alloverPage.postcodeAlert_ofa.getText();
