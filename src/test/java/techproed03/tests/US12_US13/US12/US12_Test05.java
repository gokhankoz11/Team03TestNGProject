...
public class US12_Test05 {
    ...
    public void test05() {
        ...
        //Street Address bölümü bos birakilir
        ...
        String alert = alloverPage.streetAlert_ofa.getText();
        String alert2 = "Street address is a required field.";
