...
public class US12_Test02 {
    ...
    public void test02() {
        ...
        String alert2 = "First name is a required field.";
        Assert.assertEquals(alert,alert2);
        /*String eyba = alloverPage.edityba_ofa.getText();
        System.out.println(eyba);

        Assert.assertTrue(alloverPage.edityba_ofa.isDisplayed());*/
