...
public class US13_Test05 {
    ...
    public void test05() {
        ...
        alloverPage.shippingpostcodeBox_ofa.sendKeys(Keys.TAB , Keys.ENTER);
        String eyba = alloverPage.shippostAlert_ofa.getText();
        String eyba2 = "Postcode is a required field.";
