package techproed03.tests.US12_US13.US13;
...
public class US13_Test02 {
    ...
    public void testKayit() throws InterruptedException {
        ...
        alloverPage.s_addButton_ofa.click();
    }
    @Test
    public void test02() {
        AlloverPage alloverPage = new AlloverPage();

        //Shipping address bilgileri doldurulur , First name bos birakilir
        alloverPage.firstnameButton_ofa.sendKeys(Keys.TAB + ConfigReader.getProperty("lastName_ofa"));
        alloverPage.countryMenu_ofa.click();
        alloverPage.cmBox_ofa.sendKeys(ConfigReader.getProperty("country_ofa") + Keys.ENTER);
        alloverPage.shippingstreetBox_ofa.sendKeys(ConfigReader.getProperty("street_ofa"));
        alloverPage.shippingcityBox_ofa.sendKeys(ConfigReader.getProperty("city_ofa"));
        alloverPage.shippingpostcodeBox_ofa.sendKeys(ConfigReader.getProperty("postcode_ofa") + Keys.TAB + Keys.ENTER);
        String eyba = alloverPage.shipnameAlert_ofa.getText();
        String eyba2 = "First name is a required field.";
