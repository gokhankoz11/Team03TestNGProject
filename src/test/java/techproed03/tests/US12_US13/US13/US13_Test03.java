...
public class US13_Test03 {
    ...
    public void test03() {
        ...
        //Shipping address bilgileri doldurulur
        ...
        String eyba = alloverPage.shipcountryAlert_ofa.getText();
        String eyba2 = "Country / Region is a required field.";
